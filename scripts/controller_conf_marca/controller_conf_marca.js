...
function mdl_editar_marcas(params) {
    ...
    document.getElementById('alert-edit-marca').style.display = 'block'
    document.getElementById('mdl-title').textContent = "Editar Marca"
    document.getElementById('marca').value = datoSelected.marca
    document.getElementById('mdl-btn-conf').onclick = function () { editar_marca() }
...
async function editar_marca() {
    ...
    if (server.resultado) {
        mostrar_toast('success', 'Marca editada', 'La marca ha sido editada')
    } else {
...
function mdl_nuevo_marca() {
    ...
    document.getElementById('mdl-title').textContent = "Nueva Marca"
...
async function nuevo_marca() {
    ...
    if (typeof server.resultado === "string") {
        ...
        mostrar_toast('success', 'Nueva marca', 'La marca ha sido agregada')
...
async function eliminar_marca(params) {
    ...
    if (typeof server.resultado === "string") {
        ...
        mostrar_toast('success', '¡Éxito!', 'Marca(s) eliminada(s) correctamente')
        consultar_informacion();
    } else {
