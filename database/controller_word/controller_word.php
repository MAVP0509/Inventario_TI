...
echo "<h3>Documentos generados con éxito:</h3>";
echo "<ul>";
echo "<li><a href='helloWorld.docx' download>Descargar Word (.docx)</a></li>";
echo "<li><a href='helloWorld.odt' download>Descargar ODT (.odt)</a></li>";
echo "<li><a href='helloWorld.html' target='_blank'>Ver como HTML</a></li>";
echo "</ul>";